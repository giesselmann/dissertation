...
Interestingly, both NGS and SMRT sequencing measure the fluorescence signal of nucleotides synthesized into a complementary strand of the sequenced DNA fragment.
...
While always in the range of pico ampere, any molecule passing through the pore impacts the level of the ionic current depending on its physical and chemical properties.
...
The ionic current per pore serves as a proxy signal for the molecule passing through, is recorded and translated into a nucleotide sequence by the basecalling algorithm (Fig. \ref{fig:intro:longread}, right box).
...
The portability and very low acquisition costs open new perspectives of real time sequencing in the field or clinical settings.
A more in depth description of throughput, characteristics and applications of nanopore sequencing is given in chapter \ref{cha:state_of_art}.
