...
Continuous improvements on platform, library preparation and analysis software led to increasing throughput and accuracy.
...
The availability of significantly longer reads enabled novel insights for example in assemblies, structural variant and isoform detection.
At the same time, a rapidly growing number of studies impedes a systematic and unbiased manual literature research.
Thus, the following review is based on the computational evaluation of meta data from publications in scientific journals.
...
More bacterial
Largely separated pacbio and ont
