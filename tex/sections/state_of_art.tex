...
The number of studies published in scientific journals is exponentially growing (Fig. \ref{fig:state_of_art:paper_count}).
...
A data driven literature scan can here help to cluster results and identify key publications in an unbiased way.
...
Allen Institute for AI S2ORC \cite{Lo2020} database, complement with CrossRef REST API\footnote{\url{https://github.com/CrossRef/rest-api-doc}, accessed 01/2021}
and COCI CrossRef OpenCitations Index \cite{Peroni2020}
...
Embed literature graph using node2vec is infeasible. GraphVite \cite{Zhu2019} has fast GPU implementation of DeepWalk \cite{Perozzi2014}.
