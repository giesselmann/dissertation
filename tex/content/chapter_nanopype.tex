...
\begin{center}
	20200401\_FAH12345\_FLO-MIN106\_SQK-LSK109\_HUES64\_TKO
\end{center}

From the active storage, sequencing runs can be archived on e.g. tape drives for long term data retention. For the processing, sequencing runs are mapped into an additional interface (a directory with softlinks into the active storage). This extra layer allows the distribution of raw data across multiple physical devices, while maintaining consistent access.
